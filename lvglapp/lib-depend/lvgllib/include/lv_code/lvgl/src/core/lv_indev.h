...
/**
 * Get the last pressed key state of an input device (for LV_INDEV_TYPE_KEYPAD)
 * @param indev pointer to an input device
 * @return the last pressed key state(0 on error)
 */
uint32_t lv_indev_get_key_state(const lv_indev_t * indev);
