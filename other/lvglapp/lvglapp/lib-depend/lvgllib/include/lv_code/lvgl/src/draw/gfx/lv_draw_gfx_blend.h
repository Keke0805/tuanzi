/**
 * @file lv_draw_gfx_blend.h
 *
 */

#ifndef LV_DRAW_GFX_BLEND_H
#define LV_DRAW_GFX_BLEND_H
 ...
 */
void lv_draw_gfx_blend(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_gfx_blend_dsc_t * dsc);
 ...
 * @param dsc           pointer to an initialized blend descriptor
 */
LV_ATTRIBUTE_FAST_MEM void lv_draw_gfx_blend_basic(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_gfx_blend_dsc_t * dsc);
