...
public:
    ...
    int set_style_text_letter_space( lv_coord_t value,lv_style_selector_t selector);
    int set_style_text_line_space( lv_coord_t value,lv_style_selector_t selector);
