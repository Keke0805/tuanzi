...
typedef void (*WifiStatusCallback)(ScanResult_t *pScanResult, int rCnt);
...
int Wifi_RegisterScanCallback(WifiStatusCallback pfnCallback);
void Wifi_UnRegisterScanCallback(WifiStatusCallback pfnCallback);
