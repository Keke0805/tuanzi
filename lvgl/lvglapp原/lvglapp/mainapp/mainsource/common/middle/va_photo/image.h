...
#define IMAGE_HOR_RES_MAX          (1920)
#define IMAGE_VER_RES_MAX          (1080)
#define IMAGE_DEF_ROTATE           (0)
...
typedef enum {
	...
	IMAGE_SHOW_RANDOM,
	IMAGE_SHOW_FADE,//淡出
	IMAGE_SHOW_MOSIAC,//棋盘
	IMAGE_SHOW_SLIDE_UP,//左移
	IMAGE_SHOW_SLIDE_DOWN,//右移
	IMAGE_SHOW_SLIDE_LEFT,//下移
	IMAGE_SHOW_SLIDE_RIGHT,//上移
	IMAGE_SHOW_STRETCH_UP,//左翻页
	IMAGE_SHOW_STRETCH_DOWN,//右翻页
	IMAGE_SHOW_STRETCH_LEFT,//下翻页
	IMAGE_SHOW_STRETCH_RIGHT,//上翻页
	IMAGE_SHOW_ZOOM_IN,//缩小
	IMAGE_SHOW_ZOOM_OUT,//放大
	IMAGE_SHOW_PERSIANBLIND_H,//左右手风琴
	IMAGE_SHOW_PERSIANBLIND_V,//上下手风琴
	IMAGE_SHOW_MAX,
} image_effect_show_mode_t;
...
typedef struct {
	...
	image_buffer_t full_buf; //申请好内存的临时buffer,满屏等比例图片，大小为屏幕大小
	image_buffer_t scaler_buf; //临时buffer,等比例放大图片，大小为1920*1080
...
int image_show(const char *file, image_show_mode_t mode);
...
//image decode & scaler image API by crc 
