...
bool CJsonObject::Add(const std::string& strKey, int32 iValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateNumber((uint64)iValue);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, uint32 uiValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateNumber((uint64)uiValue);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, int64 llValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateNumber((uint64)llValue);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, uint64 ullValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateNumber((uint64)ullValue);
    if (pJsonStruct == NULL)
    {
        return(false);
    }
