...
static const char * const default_kb_user_map_num[] = {"1", "2", "3", LV_SYMBOL_OK, "\n",
                                                       "4", "5", "6", LV_SYMBOL_BACKSPACE, "\n",
                                                       "7", "8", "9", LV_SYMBOL_LEFT, "\n",
                                                       "+/-", "0", ".", LV_SYMBOL_RIGHT,  ""
                                                      };

static const lv_btnmatrix_ctrl_t default_kb_ctrl_user_num_map[] = {
    1, 1, 1, LV_KEYBOARD_CTRL_BTN_FLAGS | 2,
    1, 1, 1, LV_KEYBOARD_CTRL_BTN_FLAGS | 2,
    1, 1, 1, 2,
    1, 1, 1, 2
...
static const char * * kb_map[9] = {
    ...
    (const char * *)default_kb_user_map_num,
    (const char * *)default_kb_map_lc,
    (const char * *)default_kb_map_lc,
    (const char * *)default_kb_map_lc,
    (const char * *)NULL,
