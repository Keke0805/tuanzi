...
static void lv_chinese_ime_constructor(lv_obj_t * obj)
{
    ...
    lv_obj_set_scrollbar_mode(lv_chinese_ime->font_panel, LV_SCROLLBAR_MODE_OFF);
    lv_obj_set_size(lv_chinese_ime->font_panel, LV_PCT(100), LV_PCT(6));
