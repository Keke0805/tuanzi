...
#if __CTP_USE__
#  define CTPDEV_NAME   "/dev/input/event2"
#endif

#ifndef USE_MOUSE_DEV
#  define USE_MOUSE_DEV          0
#else
#  define USE_MOUSE_DEV          1
#endif

#if USE_MOUSE_DEV
#define MOUSE_DEV_NAME   "/dev/input/event2"
#define MOUSE_DEV_FLAG   "/dev/input/mouse0"
#define MOUSE_DEV_CHECK  1
#endif

#ifndef USE_SUNXI_KEY
#  define USE_SUNXI_KEY          0
#else
#  define USE_SUNXI_KEY          1
#endif

#if USE_SUNXI_KEY
#define KEYDEV_NAME   "/dev/input/event0"
#endif
    ...
    #define ADCKEY_DEV_NAME   "/dev/input/event3"
#else
    #define ADCKEY_DEV_NAME   "/dev/input/event0"
#endif
#endif

#ifdef USE_SUNXI_IR_KEY
#define IRKEY_DEV_NAME   "/dev/input/event1"
#endif
