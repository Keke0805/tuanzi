...
protected:
    ...
    void*  TIMER_PNG=NULL;
    void*  MAIN_MENU_BACKGROUND_BUTTERFLIES_JPG=NULL;
    void*  MAIN_MENU_BACKGROUND_CHRISTMAS_JPG=NULL;
...
private:
   ...
   // static void btn_event_hander(lv_event_t *event);
    ...
    //control
    bool send_rgb_light_control_packet(unsigned char data);
    bool send_microphone_volume_control_packet(unsigned char data);
    bool send_microphone_EQ_control_packet(unsigned char data);
    bool send_volume_control_packet(unsigned char data);
