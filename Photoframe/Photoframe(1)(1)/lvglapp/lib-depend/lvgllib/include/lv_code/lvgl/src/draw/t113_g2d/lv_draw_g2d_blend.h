/**
 * @file lv_draw_g2d_blend.h
 *
 */

#ifndef LV_DRAW_G2D_BLEND_H
#define LV_DRAW_G2D_BLEND_H
 ...
 */
void lv_draw_g2d_blend(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_g2d_blend_dsc_t * dsc);
 ...
 * @param dsc           pointer to an initialized blend descriptor
 */
LV_ATTRIBUTE_FAST_MEM void lv_draw_g2d_blend_basic(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_g2d_blend_dsc_t * dsc);
