...
#if 1 //LV_FONT_MONTSERRAT_24 //must on,it is default
...
extern lv_font_t* init_default_ttf(const char* path, lv_coord_t size, int type);
extern lv_font_t* get_freetype_font(void);
extern lv_font_t* change_font_size(lv_coord_t size, int type);
#endif

typedef enum {
    DOTARRAY_MONTSERRAT_8 = 0,
    DOTARRAY_MONTSERRAT_10,
    DOTARRAY_MONTSERRAT_12,
    DOTARRAY_MONTSERRAT_14,
    DOTARRAY_MONTSERRAT_16,
    DOTARRAY_MONTSERRAT_18,
    DOTARRAY_MONTSERRAT_20,
    DOTARRAY_MONTSERRAT_22,
    DOTARRAY_MONTSERRAT_24,
    DOTARRAY_MONTSERRAT_26,
    DOTARRAY_MONTSERRAT_28,
    DOTARRAY_MONTSERRAT_30,
    DOTARRAY_MONTSERRAT_32,
    DOTARRAY_MONTSERRAT_34,
    DOTARRAY_MONTSERRAT_36,
    DOTARRAY_MONTSERRAT_38,
    DOTARRAY_MONTSERRAT_40,
    DOTARRAY_MONTSERRAT_42,
    DOTARRAY_MONTSERRAT_44,
    DOTARRAY_MONTSERRAT_46,
    DOTARRAY_MONTSERRAT_48,
    DOTARRAY_MONTSERRAT_12_SUBPX,
    DOTARRAY_MONTSERRAT_28_COMPRESSED,
    DOTARRAY_DEJAVU_16_PERSIAN_HEBREW,
    DOTARRAY_SIMSUN_16_CJK,
    DOTARRAY_UNSCII_8,
    DOTARRAY_UNSCII_16
} DOTARRAY_FONT_T;

extern lv_font_t* get_dotarray_font(void);
extern lv_font_t* init_dotarray_font(DOTARRAY_FONT_T type);
