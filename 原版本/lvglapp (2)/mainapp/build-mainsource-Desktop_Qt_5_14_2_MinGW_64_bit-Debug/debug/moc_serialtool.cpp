...
#include <memory>
#include "../../mainsource/simulator/serialtool.h"
...
QT_MOC_LITERAL(1, 11, 11), // "button_send"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 9) // "recv_send"

    },
    "SerialTool\0button_send\0\0recv_send"
};
...
void SerialTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->button_send(); break;
        case 1: _t->recv_send(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialTool::button_send)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SerialTool::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialTool::recv_send)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialTool::button_send()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SerialTool::recv_send()
{
